...
game_words = {'gore magala': 'The eyes have not developed and relies on the Frenzy Virus to hunt.',
                'zinogre': 'The spikes on its body lie flat, but when it has a built up charge, they stick out vertically into the air.',
                'dodogama': 'A stout wyvern that uses its strong lower jaw to scoop rocks and compress them into lava rocks.'
}
...
# prints each word with meaning
    ...
    for game, fact in game_facts.items():
        # THIS PART IS MUCH CLEANER vs ealier typing out the literal words like
