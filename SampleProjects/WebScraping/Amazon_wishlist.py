...
try:
    ...
    item_sales = driver.find_elements_by_class_name("itemPriceDrop")
    item_names = driver.find_elements_by_class_name("a-size-small")
    # Don't need if item_sale is True:, doesn't print
    if item_sales:
